...
› kirim atau balas foto dengan ${prefix}textmaker |adii|ganteng
...
› ${prefix}shorturl https://adyy-api.herokuapp.com

*${prefix}readmore* : membuat text baca selengkapnya
› ${prefix}readmore adii|ganteng
...
Bot inii kembangkan oleh Adii

versi bot saat ini v1.00

Kamu bisa menemukan owner bot di:
https://wa.me/60199782326

Semua info update bot akan di upload di:
t.me/adyybotz

Support us with subscribe
https://www.youtube.com/Adiination
`
}
exports.info = info()
